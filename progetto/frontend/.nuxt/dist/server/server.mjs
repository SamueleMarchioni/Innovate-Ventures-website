...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/about-e79fa00f.js").then((m) => m.default || m)
  },
  {
    name: "areas-id",
    path: "/areas/:id()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_id_-5f58cf2b.js").then((m) => m.default || m)
  },
  {
    name: "areas",
    path: "/areas",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-c4894fd6.js").then((m) => m.default || m)
  },
  {
    name: "contact",
    path: "/contact",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-2c21759c.js").then((m) => m.default || m)
  },
  {
    name: "people-id",
    path: "/people/:id()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_id_-8fc78009.js").then((m) => m.default || m)
  },
  {
    name: "people",
    path: "/people",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-c321f305.js").then((m) => m.default || m)
  },
  {
    name: "projects-id",
    path: "/projects/:id()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_id_-513c47a0.js").then((m) => m.default || m)
  },
  {
    name: "projects",
    path: "/projects",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-9eaa8c47.js").then((m) => m.default || m)
  }
];
